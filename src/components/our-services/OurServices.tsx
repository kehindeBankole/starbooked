...
function OurServices() {
  ...
  <section id='services' className={`${styles.services} `}>
      ...
      <h2 className=' text-[2rem] md:text-[3rem] lg:text-[4rem]'>our services</h2>
...
<div className="text-center uppercase md:text-[1.5rem]">
<img src={Booking} className="w-[100%]" alt="booking" />
...
<p className="lg:mb-[72px] mb-[20px]">Social media <br /> management</p>
