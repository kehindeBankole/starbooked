...
function Nav() {
  ...
  <div className={`${styles.bottomBar} container capitalize`} style={{marginTop:100 ,marginBottom:100}}>
  { window.location.href===`${window.location.protocol}//${window.location.host}/` ? null : <> Home <span style={{color:"#F9A61B"}}> {
