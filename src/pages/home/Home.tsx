...
import { Talent, Booking as BookingImg, BrandPartner, LabelService, Management, PR } from '../../assets/images';
...
function Home() {
	return (
		<section className={`${styles.homeContainer} `}>
			...
			<Booking
				title="get in touch"
				subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat eu duis donec non fames tellus."
			/>
		</section>
	);
}
