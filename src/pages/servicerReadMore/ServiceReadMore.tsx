  ...
  return (
    <div className='container text-center md:pl-[61px] pb-[120px] p-[10px] md:pr-[57px]'>
      ...
      <div>
        ...
        <h2 className='uppercase mb-[20px] font-bold  text-[1.5rem] md:text-[2rem] '>{item.moreTextHeader}</h2>
...
<div className='mb-[40px]'>
<h2 className="capitalize mb-[20px]  text-[1.5rem] md:text-[2rem] text-center font-bold mt-[10px]">Unsure? We Are Here to Help</h2>
     <p>{item.help}</p> 
</div>

<div className='mb-[40px]'>
<h2 className="capitalize mb-[20px] text-[1.5rem] md:text-[2rem] text-center font-bold mt-[10px]">Turn-Key Entertainment</h2>
