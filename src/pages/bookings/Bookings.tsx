...
<p className='mt-[50px]'>If you need any help, ask us. We are happy to answer any questions you have regarding our talent or the booking process.</p> 
      ...
      <button onClick={()=>navigate("/bookings")} className={`${styles.btn} lg:w-[156px] lg:h-[60px] lg:block hidden w-[7rem] h-[3rem] lg:text-[1rem] text-[.8rem] uppercase`}> booking <ChevronSmall className="inline w-[7%] ml-[12px]"/> </button>
...
<Explore/>
        ...
        <div>
          ...
          <header className={`uppercase ${styles.header} text-[2rem] mb-[4rem] sm:text-[3rem] lg:text-[4rem] text-center`}>Our services</header>
