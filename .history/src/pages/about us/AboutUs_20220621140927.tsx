...
import {Marquee1, Marquee2, Marquee3, Marquee4, Marquee5, Marquee6} from "../../assets/images";
      ...
      <div className={`md:pb-[159px] flex ${styles.hero_content} container justify-between items-center`}>
        ...
        <div className={`${styles.hero_text_container} md:w-[60%] lg:w-[47%] m-auto lg:p-[0] p-[20px] lg:ml-[61px]`}>
          ...
          <div className={`${styles.hero_text} `}>
            ...
            <p className=''>We pride in our global network of  individuals, and our roster of established and up-coming Artists, DJs, Celebrities etc. We strive to be a world-wide phenomenon for booking celebrities for shows, gigs, and events.
            </p>
          </div>
