...
Star Book is YOUR booking agency.					</div>
				...
				<div id="contact" className="my-[10px] xlg:my-[0] p-[3px]">
					...
					<a href="tel:07459649070">07459649070</a>, <a href="tel:08143291757">08143291757</a> .
						...
						<li id="address">
							E-mail: <a  href="mailto:info@starbook.ng"> info@starbook.ng</a> (General Inquiry).
						</li>
						<li id="address" >
							 <a href="mailto:bookings@starbook.Ng">bookings@starbook.ng</a> (Bookings).
						</li>
					</ul>
				</div>
			</div>
			...
			<div className={`flex flex-wrap justify-between  mt-[26px] capitalize ${styles.bottom_footer}`}>
				...
				<a href="https://instagram.com" target="_blank" rel="noreferrer"><img src={Instagram} alt="instagram" /></a>		
					...
					<button className="mx-[25px]">
						<a href="https://linkedin.com" target="_blank" rel="noreferrer"><img src={Linkdin} alt="linkedin" /></a>
					</button>
					<button className="mx-[25px]">
