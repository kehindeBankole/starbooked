...
<div className="lg:w-[40%]  lg:text-left text-center ">
 <header className="font-[700] lg:text-[4rem] sm:text-[2rem] text-[1.4rem] lg:w-[30%]  uppercase ">explore our rosters</header>
...
<Swiper
  ...
  <ul className="font-[700] ml-[49px]">
    ...
    <li ><button className="font-bold uppercase mb-[20px]" onClick={()=>navigate("bookings/musicians")}>Musicians</button> </li>
    <li ><button className="font-bold uppercase mb-[20px]" onClick={()=>navigate("bookings/comedians")}>comedians</button> </li>
    <li ><button className="font-bold mb-[20px]" onClick={()=>navigate("bookings/mcs")}>Mcs</button> </li>
    <li ><button className="font-bold uppercase " onClick={()=>navigate("bookings/influencers")}>influencers</button> </li>
</ul>
  </div>
  </SwiperSlide>
...
{exploreArr.map((item,index)=>(
  ...
  <div className=" relative mr-[24px] mb-[24px] md:w-[80%] w-[100%]" key={index}>
