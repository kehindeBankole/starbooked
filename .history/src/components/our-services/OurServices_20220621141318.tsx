...
import {Coporate,Concerts,PrivateParties,Birthday,Wedding,Fairs, Celeb } from '../../assets/images';
...
<div style={{cursor:"pointer"}} onClick={()=>{navigate(item.url); window.scroll(0,0);}} key={index} className="text-center uppercase md:text-[1.5rem]">
