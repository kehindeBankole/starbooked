...
const Items:Drop[]=[
  ...
  },
  {
    ...
    title: "bookings",
display:false,
dropMenu:<><li onClick={()=>navigate("bookings")} className="hover:ml-[10px] transition-all"> All </li><li onClick={()=>navigate("bookings/liveband")} className="hover:ml-[10px] transition-all"> live band </li> <li onClick={()=>navigate("bookings/dj")} className="hover:ml-[10px] transition-all"> djs</li><li onClick={()=>navigate("bookings/musician")} className="hover:ml-[10px] transition-all">musicians </li><li onClick={()=>navigate("bookings/comedian")} className="hover:ml-[10px] transition-all">comedians</li><li onClick={()=>navigate("bookings/mc")} className="hover:ml-[10px] transition-all">mc</li><li onClick={()=>navigate("bookings/influencer")} className="hover:ml-[10px] transition-all">influencers</li> </>
